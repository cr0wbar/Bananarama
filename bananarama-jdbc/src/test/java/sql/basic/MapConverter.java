...
public class MapConverter implements SqlTypeConverter<Map<String,String>>{
    ...
    @Override
    public Map<String, String> read(ResultSet rs, int index) throws BananaRamaException {
        try{
            ...
            throw new BananaRamaException("Failed to read from result set", ex);
        }
    }
    
    @Override
    public void write(PreparedStatement ps, int index, Map<String, String> obj) throws BananaRamaException {
        try{
